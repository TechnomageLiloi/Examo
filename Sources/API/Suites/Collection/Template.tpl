<div id="modules-suites-collection">
    ...
    <a href="javascript:void(0)" class="butn" onclick="Requests.Suites.create();">Create</a>
    ...
    <?php if($collection->count()): ?>
        ...
        <table>
            ...
            <?php foreach($collection as $entity): ?>
                <tr style="font-weight: bold;" class="suites <?php echo $entity->getStatusClass(); ?>">
                    <td>
                    ...
                    <td>
                        <a href="javascript:void(0)" class="butn" onclick="Requests.Suites.show('<?php echo $entity->getKey(); ?>');">Show</a> &diams;
